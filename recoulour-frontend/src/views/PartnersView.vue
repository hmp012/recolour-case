<template>
  <div :style="{ display: 'flex', flexDirection: 'column', gap: '2rem', height: '100%' }">
    ...
    <div :style="{ flexShrink: 0 }">
      ...
      <p :style="{ margin: '0.25rem 0 0 0', color: '#94a3b8' }">Monitor workload and ticket status across all active
        partners</p>
    </div>
    ...
    <div :style="{
      ...
      <div v-for="partner in partnerStats" :key="partner.name" :style="{
        ...
        <div :style="{ display: 'flex', gap: '1rem' }">
          <div
            :style="{ flex: 1, backgroundColor: '#0f172a', padding: '1rem', borderRadius: '8px', textAlign: 'center' }">
            <div :style="{ fontSize: '1.25rem', fontWeight: 'bold', color: '#22c55e' }">{{ partner.approved }}</div>
        ...
        <div>
          <div
            :style="{ fontSize: '0.875rem', fontWeight: '600', color: '#94a3b8', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }">
            <i class="pi pi-history"></i>
            Recent Activity
          </div>
          <div :style="{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }">
            <div v-for="ticket in partner.recentTickets" :key="ticket.id" :style="{
              backgroundColor: '#334155',
              ...
              <div :style="{ display: 'flex', flexDirection: 'column' }">
                <span :style="{ fontSize: '0.875rem', color: '#f8fafc', fontWeight: '500' }">#{{ ticket.referenceCode
                  }}</span>
            ...
            <div v-if="partner.recentTickets.length === 0"
              :style="{ textAlign: 'center', padding: '1rem', color: '#64748b', fontSize: '0.875rem', fontStyle: 'italic' }">
